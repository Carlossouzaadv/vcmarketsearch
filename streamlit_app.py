...
with st.sidebar:
    ...
    language = st.selectbox(
        ...
        index=0,
        help="Select the language for analysis and reports / Selecione o idioma para análise e relatórios"
    )
    ...
    # Geographic Focus
    geo_label = "🌍 Geographic Focus" if lang_code == "en" else "🌍 Foco Geográfico"
    geo_help = "Select the geographic market to focus on when discovering competitors" if lang_code == "en" else "Selecione o mercado geográfico para focar ao descobrir concorrentes"
